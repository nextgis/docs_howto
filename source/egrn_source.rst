...
Кадастровый план в формате xml с электронной подписью Росреестра придёт в личный кабинет в раздел "Заявления"
    ...
    #. Перейдите по ссылке https://www.gosuslugi.ru/600359/1/form.
    #. Нажмите кнопку «Начать».
    #. Выберите «Запросить сведения из ЕГРН».
    #. На вопрос знаете ли вы точное название документа выберите «Да».
    #. Введите «Кадастровый план территории».
    #. Выберите «Иным лицом».
    #. Выберите тип скидки если есть.
    #. Подтвердите заказ и нажмите Продолжить.
    #. Подтвердите передаваемые сведения и нажмите Перейти к заявлению
    #. Подтвердите свои паспортные данные и нажмите «Верно».
    #. Подтвердите номер телефона и нажмите «Верно».
    #. Подтвердите электронную почту и нажмите «Верно».
...
10.2025 Инструкция больше не актуальна. Сервис для заказа данных перенаправляет на Госуслуги, см. инструкцию выше.
...
2. В разделе **“Мои услуги и сервисы”** выберите **“Запрос посредством доступа к ФГИС ЕГРН”**. 
3. Отправьте запрос на верификацию аккаунта. **Верификация для физлиц происходит за счет подтвержденного аккаунта Госуслуг, ничего вводить дополнительно не нужно.**
...
.. figure:: _static/egrn_payment.png
   :name: egrn_payment_pic
   :align: center
   :width: 18cm
...
При выборе оплаты наличными нажмите **Реквизиты платежа**, чтобы получить данные для оплаты.
...
6. Можно выполнить **поиск** по кадастровому номеру земельного участка или полному адресу по ФИАС. 
7. Нажмите на нужный из результатов поиска, чтобы открыть **карточку** объекта.
8. Нажмите **“Действия”** и выберите тип сведений для получения:
