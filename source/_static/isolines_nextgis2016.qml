...
<qgis version="2.14.1-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{144f693a-9369-47ae-b751-93d0acb05a75}">
      <rule filter=" &quot;ELEV&quot;  % 100 = 0" key="{1b396210-a41a-467e-a1d6-09c9914d2a60}" symbol="0" label="Горизонтали (Сотни метров)">
        <rule scalemaxdenom="100000" filter=" &quot;ELEV&quot;  % 100 = 0" key="{271b7b88-5971-416d-b2e9-2415f6d5c03f}" symbol="1" scalemindenom="1" label="Бергштрихи"/>
      </rule>
      <rule scalemaxdenom="100000" filter="ELSE" key="{ddaed3fc-52bc-4475-ae76-f5cf383f257e}" symbol="2" scalemindenom="1" label="Горизонтали"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="152,105,3,255"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@1@0">
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="name" v="line"/>
              <prop k="offset" v="0,-0.9"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="152,105,3,255"/>
  ...
  <labeling type="rule-based">
    <rules>
      <rule scalemaxdenom="100000" description="Высоты" filter=" &quot;ELEV&quot;  % 100 = 0" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="Ubuntu" fontLetterSpacing="0" fontUnderline="0" fontSizeMapUnitMaxScale="0" fontWeight="63" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="152,105,3,255" fontSizeMapUnitMinScale="0" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSize="7" fieldName="ELEV" namedStyle="Medium" fontWordSpacing="0"/>
          ...
          <text-buffer bufferSize="0.8" bufferSizeMapUnitMinScale="0" bufferColor="255,255,255,255" bufferDraw="1" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferSizeMapUnitMaxScale="0" bufferNoFill="0" bufferJoinStyle="64"/>
          ...
          <placement repeatDistanceUnit="1" placement="2" maxCurvedCharAngleIn="20" repeatDistance="0" distMapUnitMaxScale="0" labelOffsetMapUnitMaxScale="0" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" centroidWhole="0" priority="5" repeatDistanceMapUnitMaxScale="0" yOffset="0" offsetType="0" placementFlags="11" repeatDistanceMapUnitMinScale="0" centroidInside="0" dist="0" angleOffset="0" maxCurvedCharAngleOut="-20" fitInPolygonOnly="0" quadOffset="4" distMapUnitMinScale="0" labelOffsetMapUnitMinScale="0"/>
