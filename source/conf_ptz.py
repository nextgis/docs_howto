...
latex_documents = [
  (master_doc, 'NextGISWEBHOWTO.tex', u'Документация к ГИС Приокско-Террасного заповедника',
   u'Артём Светлов', 'manual', 'true'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
#latex_logo = '_static/mobileappIcon.png'
latex_logo = ''
...
texinfo_documents = [
  (master_doc, 'NextGISWEBHOWTO', u'NextGISWEBHOWTO',
   author, 'NextGISWEBHOWTO', 'One line description of project.',
   'Miscellaneous'),
]
