...
Это типичный проект QGIS, в котором есть растровые и векторные слои, пара базовых карт и разнообразные стили, зависящие от масштаба. Для отображения точек интереса используется динамическая кластеризация. Для слоя "Дорожная сеть" используются встроенные SVG-значки.
...
Меняйте масштаб колёсиком мыши или кнопками панели инструментов, чтобы увидеть разные стили в зависимости от приближения.
