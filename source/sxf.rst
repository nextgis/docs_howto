...
3. Доступ к Веб ГИС на платформе :program:`NextGIS Web` - у вас должен быть его URL, логин и пароль.
...
Откройте в браузере имеющийся у вас адрес Веб ГИС, введите логин и пароль. Вы попадёте в админку. При желании вы можете создать в ней каталог ("группу ресурсов"), чтобы работать с тестовыми данными в ней. Затем нажмите :guilabel:`Векторный слой`.
