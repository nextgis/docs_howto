...
В первый раз будет выведена информация: при публикации данных вам положено 
указать источник - "ASTER GDEM is a product of METI and NASA.", и учитывать что 
в данных могут быть неточности.
