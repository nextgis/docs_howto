...
На сервере, где планируется развернуть Nominatim, создайте директорию ``/srv/nominatim`` и перейдите в нее, скачайте шаблон конфигурации (:download:`nominatim.zip <http://nextgis.ru/extra/nominatim/nominatim.zip>`) и распакуйте его. Если установка производится на сервере без доступа в Интернет, скачайте файл на другом ПК и перенесите его на сервер.
